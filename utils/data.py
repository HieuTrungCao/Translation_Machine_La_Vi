...
def t_src_tokenizer(sentence):
    return lo_tokenize(sentence.strip())
...
def create_fields(src_lang, trg_lang):
    ...
    TRG = data.Field(
        lower=True, tokenize=t_trg_tokenizer, init_token="<sos>", eos_token="<eos>"
    )
...
def create_dataset(
    src_data, trg_data, max_strlen, batchsize, device, SRC, TRG, istrain=True
):
    ...
    train = data.TabularDataset(
        "./translate_transformer_temp.csv", format="csv", fields=data_fields
    )
